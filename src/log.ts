...
class Log {
  ...
  askForReport(): void {
    console.info(
      'The following error is a bug. Please open an issue on the glider issue structure with a link to your repository and the output from this command.'
    )
    console.info(
      'The glider issue tracker is located at: https://github.com/glide-browser/glider/issues'
    )
  }
}
