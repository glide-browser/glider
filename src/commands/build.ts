...
const applyConfig = async (os: string) => {
  ...
  try {
    ...
    log.warning(
      'Glider expects that you are building your browser with git as your version control'
    )
    log.warning(
