...
export const commands: Cmd[] = [
  {
    cmd: 'bootstrap',
    description: 'Bootstrap the glider app.',
  ...
  },
  {
    ...
    aliases: ['b'],
    description:
      'Build the glider app. Specify the OS param for cross-platform builds.',
    options: [
      {
        arg: '--u, --ui',
        description:
  ...
  },
  {
    ...
    requestController: async () =>
      (await import('./commands/package')).gliderPackage,
  },
  {
    cmd: 'reset',
  ...
  {
    cmd: 'setup-project',
    description: 'Sets up a glider project for the first time',
    requestController: async () =>
